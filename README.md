...
Some of the figures created for the book did not translate well to print. To address this I have included all of the book figures in this repository and published the figures online at: [https://github.com/gamephysicscookbook/Figures](https://github.com/gamephysicscookbook/Figures)
